from modules.luigi_tasks import Calc_predict_data, Simulate_predict_data, Simulate_kaime_data
...
if __name__ == "__main__":
    ...
    luigi.build([Simulate_kaime_data(start_date=start_date, end_date=end_date, skproc=skproc,intermediate_folder=intermediate_folder, export_mode=export_mode)],
